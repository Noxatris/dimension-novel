...
export default function Header() {
    ...
    return (
        <header className="w-screen md:h-[120px] flex flex-wrap items-center shadow-2xl bg-gradient-to-b from-gray-800 to-indigo-600 md:flex-nowrap">
            <div className="flex items-center p-4 md:p-8 w-[80%] md:w-[40%]">
            ...
            {/* Liste des liens */}
            <ul className={`w-full md:h-full shadow-lg rounded-md overflow-hidden md:w-[60%] md:shadow-none md:flex md:flex-row-reverse md:justify-end md:text-lg transition-all duration-500 ease-in-out ${isOpen ? 'max-h-screen opacity-100' : 'max-h-0 md:max-h-[120px] opacity-0 md:opacity-100'}`}>
