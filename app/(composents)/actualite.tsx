    ...
    return (
        <div className="h-[45vh] flex flex-col bg-black/50 pt-[18vh] px-2">
            ...
            <div className="border-l-4 rounded border-violet-700 px-3 mb-6">
                <h3 className="text-xl font-[MedievalSharp] border-b-2 mb-3">Le titre de l&aposactu</h3>
                <p>Et les information de l&aposactu evidemment toute incroyable et exeptionnelle et j&aposécris pas tout ça juste pour remplir, enfin peut etre que si finalement</p>
            </div>
            <div className="border-l-4 rounded border-violet-700 px-3">
                ...
                <p>Je fais genre j&aposécris un truk mé en vrai tt le monde sen fou é c just pr tst</p>
            </div>
            </div>
