export default function Actualite() {
    return (
        <div className="h-[45vh] flex flex-col bg-black/50 pt-[18vh] px-2">
            ...
            <div className="flex flex-col overflow-y-scroll pb-2">
                <div className="border-l-4 rounded-xl border-violet-700 px-3 mb-6 bg-black/60">
                ...
                <div className="border-l-4 rounded-xl border-violet-700 px-3">
