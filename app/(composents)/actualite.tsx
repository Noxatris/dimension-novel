...
import AltActualite from './Squeltron/alt_actualite';
...
export default function Actualite() {
  ...
  return (
    <div className="h-[45vh] md:h-[350px] lg:h-[35vh] flex flex-col md:items-center pt-8 px-4 md:px-8 lg:px-12 md:mb-8">
