...
export default function Eternalys() {
    return (
        <div className='w-full md:h-[90vh] md:w-[60%] xl:w-[30%] xl:mx-[10%] bg-black/55 flex flex-col items-center md:justify-between bg-top bg-cover shadowTest' style={{ backgroundImage: 'url(coverClear.png)' }} >
