...
export default function Eternalys() {
    return (
        <div className='w-full md:h-auto md:max-h-[90vh] md:min-h-[90vh] md:w-[60%] xl:w-[30%] xl:m-auto bg-black/55 flex flex-col items-center md:justify-between bg-top bg-cover shadow-shadowBg' style={{ backgroundImage: 'url(coverClear.png)' }} >
            ...
            <Link href="/eternalys/1" className='flex justify-center items-center p-2 rounded-full bg-gradient-to-r from-yellow-200 to-purple-600 gradientMoveAnimation shadow-xl text-[1.2em] mb-8 hover:bg-yellow-300 hover:text-black transition-all duration-300'>
